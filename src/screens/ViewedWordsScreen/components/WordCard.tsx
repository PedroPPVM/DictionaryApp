...
import { Text, TouchableOpacity, Vibration, View, StyleSheet } from "react-native";
  ...
  return (
    ...
    >
      <View style={{flex: 1, gap: 5}}>
        ...
        <Text style={styles.text}>Definition: {wordData.meanings[0].definitions[0].definition}</Text>
      </View>
      
      <View style={styles.iconBox}>
        <TouchableOpacity onPress={() => onDeleteWord()} disabled={isLoadingDelete}>
          {isLoadingDelete ? (
