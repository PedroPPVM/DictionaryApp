...
import { View, Text, StyleSheet, TouchableWithoutFeedback, KeyboardAvoidingView, Platform, Keyboard } from "react-native";
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.container}>
        <Animatable.View animation="fadeInUp" iterationCount={1} direction="alternate" style={styles.box}>        
          <Animatable.Image 
            animation="pulse" 
            easing="ease-out" 
          ...
          <View style={{width: '100%'}}>
            <CustomInput icon="search" placeholder="Search a word..." value={word} onChangeText={setWord} />
          </View>
